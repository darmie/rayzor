...
- [x] Update RegisterFile to use NanBoxedValue (Copy semantics - no cloning!)
- [x] Update all binary/unary operations (fast NaN-boxed paths)
- [ ] Benchmark and tune
...
- [x] Add decoded block cache infrastructure
