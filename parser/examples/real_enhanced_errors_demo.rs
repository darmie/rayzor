...
use parser::{
    ErrorFormatter, SourceMap, SourceSpan, SourcePosition, FileId,
    Diagnostics, HaxeDiagnostics, DiagnosticBuilder
};
...
"#;
    ...
    diagnostics.push(HaxeDiagnostics::missing_semicolon(span, "variable declaration"));
...
"#;
    ...
    diagnostics.push(HaxeDiagnostics::missing_semicolon(span2, "variable declaration"));
