...
use compiler::ir::{
    ...
    IrType, IrId, IrInstruction, IrTerminator,
    IrValue, CompareOp, CallingConvention,
};
...
fn main() {
    ...
    println!("✓ Promoted to Tier 1 after {} calls (optimized Cranelift)", warm_threshold);
    println!("✓ Promoted to Tier 2 after {} calls (aggressive Cranelift)", hot_threshold);

    #[cfg(feature = "llvm-backend")]
    println!("✓ Promoted to Tier 3 after {} calls (LLVM maximum optimization)", blazing_threshold);
