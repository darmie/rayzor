...
// Test StringTools with direct static method calls
use compiler::codegen::CraneliftBackend;
use compiler::compilation::{CompilationConfig, CompilationUnit};

fn main() {
    let source = include_str!("test_stringtools_direct.hx");
    ...
    // Add the test file
    if let Err(e) = unit.add_file(source, "test_stringtools_direct.hx") {
