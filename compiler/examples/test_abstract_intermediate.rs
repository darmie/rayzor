...
//! Test abstract type methods with intermediate variables
...
fn main() -> Result<(), String> {
    println!("\n=== Testing Abstract Type with Intermediate Variables ===\n");

    test_intermediate_variable()?;

    Ok(())
}

fn test_intermediate_variable() -> Result<(), String> {
    println!("Test: Method call with intermediate variable\n");
    ...
    let source = r#"
        ...
        class Main {
            public static function main():Int {
                var a:Counter = 15;
                var b:Counter = a;
                return b.toInt();  // Should return 15
            }
        }
    "#;
    ...
    if result == 15 {
        println!("✅ TEST PASSED: Intermediate variable works!");
        println!("  Result: {}\n", result);
        Ok(())
    } else {
