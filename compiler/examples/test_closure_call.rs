...
fn main() -> Result<(), String> {
    ...
    // Test: Closure that captures variable from outer scope and is called
    let source = r#"
        package test;
        ...
        class ClosureTest {
            public static function main():Int {
                ...
                return addX(32);  // Should return 42 (10 + 32)
            }
        }
    "#;
    ...
    println!("✓ Closure with captured variable created and called!");
    println!("✓ Execution result: {}", result);
    println!("\nExpected: 42 (10 + 32 with captured x)");

    if result == 42 {
        println!("\n✓ TEST PASSED! Closure invocation working correctly!");
        Ok(())
    } else {
