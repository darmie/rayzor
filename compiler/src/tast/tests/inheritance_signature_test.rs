...
mod inheritance_signature_tests {
    ...
    fn test_inheritance_wrong_parameter_count() {
        ...
        let has_signature_error = result
            .errors
            .iter()
            .any(|e| e.message.contains("signature") || e.message.contains("parameter"));
    ...
    fn test_correct_inheritance_override() {
        ...
        assert!(
            !has_signature_error,
            "Should not have signature errors for correct overrides"
        );
    }
    ...
    fn test_deep_inheritance_chain() {
        ...
        let has_missing_override = result
            .errors
            .iter()
            .any(|e| e.message.contains("method2") && e.message.contains("override"));

        println!(
            "Deep inheritance errors: {:?}",
            result
                .errors
                .iter()
