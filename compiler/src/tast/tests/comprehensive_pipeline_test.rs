...
"#;
        ...
        assert!(!result.errors.is_empty(), "Should detect type checking errors");
        ...
        let expected_errors = vec![
            ...
            "String", "Int",  // Type mismatch details
        ...
        println!("\n=== Validation Results ===");
        println!("Expected error patterns found: {}/{}", found_errors, expected_errors.len());
        ...
        for error in &result.errors {
            ...
            if error.location.line > 0 && error.location.column > 0 {
                ...
                println!("  ✓ Accurate location: line {}, column {}", 
        ...
        println!("Accurate source locations: {}/{}", accurate_locations, total_locations);
        ...
        if total_locations > 0 {
            ...
            if accuracy_rate < 80.0 {
                println!("WARNING: Source location accuracy is low: {:.1}%", accuracy_rate);
            }
        }
