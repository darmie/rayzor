...
class Dog extends Animal {
    ...
    public function move(distance:Float):Void {
        ...
        assert!(
            has_helpful_errors,
            "Should have helpful diagnostic messages"
        );
    }
...
class DerivedClass extends BaseClass {
    ...
    override public function anotherFakeMethod():String {
        ...
        assert!(
            ...
            "Should suggest removing override modifier"
        );
    }
...
class Bicycle extends Vehicle {
    ...
    override public function pedal():Void {
        ...
        assert!(
            !missing_override_errors.is_empty(),
            "Should have missing override errors"
        );
        assert!(
            !invalid_override_errors.is_empty(),
            "Should have invalid override errors"
        );
        assert!(
            !signature_mismatch_errors.is_empty(),
            "Should have signature mismatch errors"
        );
    }
}
