...
class SwitchTest {
    static function main() {
        ...
        assert!(result.errors.iter().any(|e| e.message.contains("Type mismatch")), 
            "Expected type mismatch error, but got: {:?}", result.errors);
    }
...
class SwitchTest {
    static function main() {
        ...
        assert!(!result.errors.is_empty(), "Expected error for void in expression");
    }
...
class SwitchTest {
    static function main() {
        ...
        assert!(result.errors.iter().any(|e| 
            e.message.contains("Type mismatch") && e.message.contains("String") && e.message.contains("Int")
        ), "Expected Int to String type mismatch, but got: {:?}", result.errors);
    }
...
class SwitchTest {
    static function main() {
        ...
        assert!(!result.errors.is_empty(), "Expected error for missing case expression");
    }
}