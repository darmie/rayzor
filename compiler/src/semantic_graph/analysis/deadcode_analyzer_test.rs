...
mod deadcode_analysis_tests {
    ...
    use crate::semantic_graph::{
        ...
        dfg::{SsaVariable, ConstantValue, NodeMetadata, LivenessInfo},
    };
    use crate::tast::{
    ...
    pub fn create_test_cfg_with_unreachable_blocks() -> ControlFlowGraph {
        ...
        let another_reachable = BasicBlock {
            ...
            terminator: Terminator::Jump { target: BlockId::from_raw(4) },
            predecessors: new_id_set(),
    ...
    pub fn create_test_dfg_with_unused_variables() -> DataFlowGraph {
        ...
        dfg.ssa_variables.insert(SsaVariableId::from_raw(4), SsaVariable {
    ...
    pub fn create_test_call_graph_with_unreachable_functions() -> CallGraph {
        ...
        let main_call = CallSite::new(
            ...
            main_func,
            CallTarget::Direct { function: called_func },
            CallType::Direct,
            BlockId::from_raw(1),
        ...
        let unreachable_call = CallSite::new(
            ...
            unreachable_func,
            CallTarget::Direct { function: transitive_unreachable },
            CallType::Direct,
            BlockId::from_raw(1),
...
mod deadcode_analysis_performance_tests {
    use super::*;
    use crate::semantic_graph::analysis::{deadcode_analyzer::DeadCodeAnalyzer, ownership_analyzer::FunctionAnalysisContext};
    ...
    fn test_large_function_performance() {
        ...
        let call_graph = deadcode_analysis_tests::create_test_call_graph_with_unreachable_functions();
