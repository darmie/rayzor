...
use crate::tast::{SourceLocation, SymbolId, DataFlowNodeId, BlockId, CallSiteId};
...
pub fn create_source_location(line: u32, column: u32, file_id: u32, byte_offset:u32 ) -> SourceLocation {
    SourceLocation {
        line,
        column,
        file_id,
