...
fn main() {
    ...
    println!(
        "Simple pipeline processed: {} files",
        simple_result.stats.files_processed
    );
    println!(
        "Complex pipeline processed: {} files",
        complex_result.stats.files_processed
    );
    println!(
        "Comprehensive pipeline score: {}/100",
        comprehensive_result.info_preservation_score
    );
    println!(
        "Type parameter validation score: {}/100",
        type_param_result.info_preservation_score
    );
    println!(
        "Property validation score: {}/100",
        property_result.info_preservation_score
    );
    println!(
        "Metadata validation score: {}/100",
...
fn run_basic_tests() {
    ...
    let successful_parses = all_results
        .iter()
        .filter(|r| r.stats.files_processed > 0)
        .count();
